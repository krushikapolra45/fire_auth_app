...
class _PhoneNumberScreenState extends State<PhoneNumberScreen> {
  ...
  Widget inputTextField(String labelText, TextEditingController textEditingController, BuildContext context) => Padding(
...
class FirebaseAuthentication {
  ...
  authenticate(ConfirmationResult confirmationResult, String otp) async {
    ...
    userCredential.additionalUserInfo!.isNewUser ? printMessage("Authentication Successful") : printMessage("User already exists");
  }
